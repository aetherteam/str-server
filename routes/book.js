...
async function routes(fastify, options) {
  ...
  fastify.get("/book/getOne/", async (request, reply) => {
    ...
    const result = await Book.getOne(rp.bookID, rp.userID, rp.countAsView);
  ...
  fastify.get("/book/getByAuthor/", async (request, reply) => {
    console.time("Book getByAuthor executed in");
    console.log(request.query);
    const result = await Book.getByAuthor(request.query.author);
    ...
    console.timeEnd("Book getByAuthor executed in");
  });
