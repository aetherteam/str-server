...
module.exports = {
    create: async function (
        ...
        const booksCollection = global.db;
    ...
    getOne: async function (bookID) {
        ...
        const author = await services.query(("http://localhost/user/get?userID=" + book.author, "GET"));
    ...
    get: async function (arrangeType, shift = 0, count = 10) {
        ...
        if (arrangeType === "newest") {
            ...
            sort = ["timestamp", "asc"];
        } else if (arrangeType === "popular") {} else if (arrangeType === "recommended") {} else {
        ...
        for (const book of books) {
            ...
            if (!cache.authors[book.author]) {
                author = await services.query(("http://localhost/user/get?userID=" + book.author, "GET"));
